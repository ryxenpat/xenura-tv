...
// Mouse Tracking
let mouseAngle = 0;
let mouseDistanceToShip = 0;
// Graphics
let shipImage = new Image();
shipImage.src = 'images/game/x-ship.png';
let shipSize = 64; // px

let shipCrosshair = new Image();
shipCrosshair.src = 'images/game/x-ship-crosshair.png';
let shipCrosshairSize = 64;
const shipCrosshairMinSize = 24;
const shipCrosshairMaxSize = 64;
const minDistance = shipSize;
const maxDistance = 700;

let shipBulletStandard = new Image();
shipBulletStandard.src = 'images/game/x-ship-bullet-standard.png'
let shipBulletWidth = 24;
let shipBulletHeight = 24;

let shipX = 0;
let shipY = 0;
let shipMoveSpeed = 3;
let bulletSpeed = 7;
let shipFront = getShipFront();
...
async function startTime() {
    ...
    while (gameRunning) {
		...
		if (gameActive === true) {
			...
			mouseAngle = Math.atan2(mouseY - shipY, mouseX - shipX);
			shipCrosshairSize = getCrosshairSize(mouseDistanceToShip);
